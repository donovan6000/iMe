...
#define EEPROM_LAST_RECORDED_X_VALUE_OFFSET 0x2A3
#define EEPROM_LAST_RECORDED_X_VALUE_LENGTH 4
#define EEPROM_LAST_RECORDED_Y_VALUE_OFFSET 0x2A7
...
#define EEPROM_X_AXIS_STEPS_PER_MM_OFFSET 0x2D4
#define EEPROM_X_AXIS_STEPS_PER_MM_LENGTH 4
#define EEPROM_Y_AXIS_STEPS_PER_MM_OFFSET 0x2D8
#define EEPROM_Y_AXIS_STEPS_PER_MM_LENGTH 4
#define EEPROM_SAVED_X_STATE_OFFSET 0x2DC
#define EEPROM_SAVED_X_STATE_LENGTH 2
#define EEPROM_SAVED_Y_STATE_OFFSET 0x2DD
#define EEPROM_SAVED_Y_STATE_LENGTH 2
